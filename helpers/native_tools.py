...
_IDENTITY = dict(
    peer_id=_TEXT, tool_name=dict(type="string", pattern=r"^mcp://[^/]+/.+", maxLength=1024)
)
SCHEMAS = {
    ...
    "sam_preflight_tool": _schema(
        {**_IDENTITY, "arguments": {"type": "object"}, "data_class": {"enum": ["public"]}},
        ("peer_id", "tool_name", "arguments", "data_class"),
    ),
    "sam_call_remote_tool": _schema(
        {"decision_id": dict(type="string", minLength=20, maxLength=128)}, ("decision_id",)
    ),
